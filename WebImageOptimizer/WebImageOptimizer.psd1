#
# Module manifest for module 'WebImageOptimizer'
#
# Generated by: PowerShell Web Image Optimizer Team
#
...
RootModule = 'WebImageOptimizer.psm1'
...
FunctionsToExport = @('Optimize-WebImages', 'Invoke-WebImageBenchmark')
